...
const copy = {
  lv: {
    ...
    reasons: {
      ...
      'invalid-manual-value': 'Saglabāto manuālo vērtību neizdevās droši normalizēt atbilstoši sākotnējam slicer formātam.',
  ...
  en: {
    ...
    reasons: {
      ...
      'invalid-manual-value': 'The stored manual value could not be safely normalized to the source slicer value format.',
