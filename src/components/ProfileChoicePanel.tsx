...
const copy: Record<'lv' | 'en', Copy> = {
  lv: {
    ...
    baseline: 'Mans drukas profils',
    useProject: 'Paturēt projekta vērtību',
    useBaseline: 'Izmantot mana profila vērtību',
    selectedBaseline: 'No mana profila izvēlēts: {{count}}',
    reset: 'Atiestatīt izvēles',
    summary: '{{count}} atšķirības izvērtēšanai',
    noChanges: 'Nav atšķirību, kurām nepieciešama izvēle.',
    unavailable: 'Manā profilā šīs vērtības nav',
    ...
    reportSubtitle: 'Precīzi redzi, kas paliks no projekta un ko plānots aizstāt ar mana profila vērtību.',
    ...
    sourceBaseline: 'MANS PROFILS',
    noPlannedChanges: 'Pašlaik nav izvēlēta neviena mana profila vērtība, tāpēc projekts paliktu nemainīts.',
  ...
  en: {
    ...
    baseline: 'My print profile',
    useProject: 'Keep project value',
    useBaseline: 'Use my profile value',
    selectedBaseline: 'Selected from my profile: {{count}}',
    reset: 'Reset decisions',
    summary: '{{count}} differences to review',
    noChanges: 'There are no differences that need a decision.',
    unavailable: 'No value available in my profile',
    ...
    reportSubtitle: 'See exactly what stays from the project and what is planned to come from my print profile.',
    ...
    after: 'After',
    sourceProject: 'PROJECT',
    sourceBaseline: 'MY PROFILE',
    noPlannedChanges: 'No print-profile values are currently selected, so the project would remain unchanged.',
