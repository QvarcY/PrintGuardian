              ...
              <div className={`update-handoff ${portable ? 'portable' : 'installed'}`}>
                ...
                <span>{candidate.simulated
                  ...
                  : portable
                    ...
                    : (lv ? 'Atver oficiālā laidiena lapu un palaid jauno instalatoru virs esošās instalācijas. Šajā unsigned Preview versijā automātiska instalēšana ir apzināti izslēgta.' : 'Open the official release page and run the newer installer over the existing installation. Automatic installation is deliberately disabled in this unsigned Preview release.')}</span>
              </div>
