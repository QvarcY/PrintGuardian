export const lv = {
  app: {
    ...
    safeCopySoon: 'Verificēts eksperimentāls eksports ir pieejams Salīdzināt → Mans etalons pilnībā kartētām atbalstītām izmaiņām.',
    ...
    prototype: 'v0.3.0-dev.8 · Readability & UI Scale',
    language: 'Valoda',
