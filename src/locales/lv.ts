export const lv = {
  app: {
    ...
    safeCopySoon: 'Lēmumu priekšskatījums ir pieejams Salīdzināt → Mans etalons. 3MF eksports vēl nav ieviests.',
    ...
    prototype: 'v0.3.0-dev.3 · Profile Diff + Baseline Decisions',
    language: 'Valoda',
