export const en = {
  app: {
    ...
    safeCopySoon: 'Verified export is available in the project workspace for fully mapped supported changes.',
    ...
    prototype: 'v0.3.0-dev.12 · Tauri desktop shell + Windows distribution build',
    language: 'Language',
  ...
  compare: {
    ...
    focus: 'View filter', differencesOnly: 'Differences only', highOnly: 'High impact only', showAll: 'Show all', showing: 'Showing {{count}} of {{total}} parameters', noRows: 'No parameters match this filter.',
    whyItMatters: 'Why it matters', expectedEffect: 'What this change may affect',
    impact: { high: 'High impact', medium: 'Medium impact', low: 'Low impact' },
    category: { compatibility: 'Compatibility', adhesion: 'Adhesion', quality: 'Quality', strength: 'Strength', flow: 'Material flow', process: 'Process' },
    dna: { title: 'Print DNA comparison', subtitle: 'A fast visual comparison of the two projects’ print character.', disclaimer: 'Print DNA is an experimental signal derived from selected 3MF values, not a print-quality guarantee.' },
    explanations: {
  ...
  baseline: {
    title: 'My print profile',
    empty: 'Add a trusted 3MF as a local comparison profile for your printer and usual settings.',
    save: 'Save current as My print profile',
    saved: 'Saved {{date}}',
    compare: 'Compare with my profile',
    inUse: 'My profile active',
    replace: 'Replace with current',
    remove: 'Remove',
    myBaseline: 'My print profile',
    ...
    referenceDisclaimer: 'My print profile is a local comparison reference, not a safety certification. Differences still require judgement before printing.',
    replaceConfirm: 'Replace the saved print profile with the currently loaded project profile?',
    removeConfirm: 'Remove the saved print profile?',
    saveFailed: 'The print profile could not be saved in local storage.',
    removeFailed: 'The print profile could not be removed from local storage.'
  },
  settings: {
    maxVolumetricSpeed: {
