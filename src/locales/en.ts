export const en = {
  app: {
    ...
    recentProject: 'Previous project',
    continueRecent: 'Continue',
    forgetRecent: 'Remove saved project copy',
    recentMissing: 'The previously saved project could no longer be opened. Choose the 3MF file again.',
  ...
  baseline: {
    ...
    privacy: 'A print-profile entry stores only extracted metadata and selected settings. Separately, PrintGuardian may keep a local copy of the last opened 3MF for convenient resume; that cached copy can be removed from the start screen at any time.',
